...
return (
     <div className="public-status-page bulb-pulse-wave animate relative">
       <header className="public-status-header phosphor-grid-pulse animate">
         <div className="public-status-container">
           <AppBrand href={`/status/${slug}`} />
           <p className="text-xs text-muted">Status page</p>
         </div>
       </header>
       <main className="public-status-container public-status-content">
        {loading ? (
          <MonitorBayLoading />
        ) : error ? (
          <section
            ...
            aria-live="polite"
          >
            <h1>Unable to load this status page</h1>
            <p>{error}</p>
          </section>
        ) : monitors.length === 0 ? (
          <section className="public-empty">
            ...
            <p>
              This status page does not have any active monitors to display.
            </p>
          </section>
        ) : (
          <>
            ...
            <section className="mt-8">
              <div className="mb-4">
                ...
                <p className="mt-1 text-sm text-[var(--text-muted)]">
                  Live status for monitored services
                </p>
              </div>
      ...
      <footer
        className="public-status-container public-status-footer"
      >
        Powered by PulseCheck · Live status updates every{
